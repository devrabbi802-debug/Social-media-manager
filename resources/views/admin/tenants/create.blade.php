...
<div class="max-w-4xl space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h1 class="text-lg font-bold text-gray-900">Create New Tenant</h1>
            <p class="text-sm text-gray-500 mt-0.5">Set up a new tenant with their own database and subdomain</p>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.tenants.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label for="id" class="block text-sm font-medium text-gray-700 mb-2">Subdomain (ID) *</label>
                        ...
                        <p class="mt-1 text-xs text-gray-500">This will be used as subdomain (e.g., <strong>acme</strong>.socialboost.com)</p>
                    </div>
