            ...
            <div class="p-4">
                ...
                <a href="{{ route('admin.ai-prompt.index') }}" class="flex items-center p-3 rounded-xl hover:bg-teal-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500">System & image prompts</p>
                    </div>
                ...
                <a href="{{ route('admin.ai-image-prompt.index') }}" class="flex items-center p-3 rounded-xl hover:bg-amber-50 transition-colors group">
                    <div class="w-10 h-10 bg-amber-50 rounded-xl flex items-center justify-center mr-3 border border-amber-100 group-hover:bg-amber-100 transition-colors">
                        <svg class="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-900 group-hover:text-amber-700 transition-colors">Image Prompt</p>
                        <p class="text-xs text-gray-500">CLIP image analysis</p>
                    </div>
