...
@section('title', 'Create Business Category - Admin')

@section('content')
<div class="max-w-3xl" x-data="categoryForm()">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Business Category</h1>
            <p class="text-gray-500 text-sm mt-1">Add a new business category for onboarding</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.business-categories.store') }}">
        ...
        <div class="bg-white rounded-xl shadow-sm border p-6 space-y-6">
            ...
            <div class="border-t pt-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-gray-900">Extra Fields (Category-Specific)</h3>
                ...
                <div x-show="fields.length === 0" class="text-center py-6 text-gray-400 text-sm">
                    No extra fields defined. Click "+ Add Field" to add category-specific fields.
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 flex justify-end space-x-3">
            ...
            <button type="submit"
                    class="px-6 py-2.5 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 transition text-sm">Create Category</button>
        </div>
    </form>
</div>
