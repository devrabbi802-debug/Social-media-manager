    ...
    <section className="py-12 bg-surface">
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center">
          ...
          {submitted ? (
            <div className="bg-green-50 text-green-700 p-4 border border-green-200">Thank you for subscribing!</div>
          ) : (
            <form onSubmit={handleSubmit} className="flex gap-0">
              ...
              />
              <button type="submit" className="bg-primary text-white px-6 py-3 hover:bg-primary/90 transition flex items-center gap-2">
