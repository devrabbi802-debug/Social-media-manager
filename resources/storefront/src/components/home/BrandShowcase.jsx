              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 hover:shadow-md transition">
                {brand.logo ? (
                  <img
                    ...
                    alt={brand.name}
                    className="h-12 w-auto object-contain group-hover:scale-105 transition"
                  />
                ) : (
                  <span className="text-lg font-medium text-gray-700 group-hover:text-primary transition">
                    {brand.name}
                  </span>
                )}
              </div>
